<?php   if ($_SESSION['user']['department']==0 || $_SESSION['user']['department']==3): ?>
        ...
        <div class="container-fluid mt-2" id="content">
            <div class="row">
                <div class="col-md-3 pr-3" style="width:100%">
                    <?php require "mnemos/localprom.php" ?>
                    <div class="row mt-2">
                        <div class="col-md-12 text-right ml-auto mr-0">
                            <button class="btn btn-sm btn-success  mx-2 px-2 addfill" id="FProm" data-toggle="tooltip" title="Заполнить форму налива вручную" style="width:30%">Добавить данные</button>
                            <button class="btn btn-sm btn-info mx-2 px-2 monreport" id="mFProm" data-toggle="tooltip" title="Создать суммарный отчет (н-р: за месяц)" style="width:30%">Суммарный отчет</button>
                ...
                <div class="col-md-9" style="width:100%">
                    <div class="row mt-2">
                        <div class="col-md-12" style="width:100%; height:auto" id="localpromtablecontent">
                        </div>
                    </div>                    
                </div>
            </div>
    ...
    <script src="public/js/develop/localpromscripts.js"></script>
<?php else: ?>
